...
internal interface IURLBuilder
{
    ...
    string BuildURL(string protocol, string host, string basePath, string endpoint, bool https = true);
}

internal static class URLBuilderExtensions
{
    public static string BuildLocalHostURL(this IURLBuilder urlBuilder, string protocol, string basePath, string endpoint, bool https = false)
    {
        return urlBuilder.BuildURL(protocol, "127.0.0.1", basePath, endpoint, https);
    }
}
